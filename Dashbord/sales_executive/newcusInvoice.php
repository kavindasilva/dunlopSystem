      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview ">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o active " style="color:aliceblue;"></i><span style="color:aliceblue;">New Order</span></a></li>
...
<button type="submit" class="btn btn-success" style="width: 70px">Add</button></br></br>
 </div>
 </form>
  <div class="row">
        <div  class="col-xs-12" style="width: auto; margin-left: 72px">
          <div class="box" >
            ...
            <div class="row">
            <div class="col-md-3">
            	<button type="button" class="btn btn-danger" style="width: 153px">Remove All Items</button>
            	</div>
